...
export default {
    data() {
        return {
            ...
            list2:[
                {
                    id:1,safeName:'apple',checked:true
                },
                   {
                    id:2,safeName:'apple2',checked:true
                },
                   {
                    id:3,safeName:'apple3',checked:true
                },
            ]
        };
    },
    ...
    computed: {
        insurTypeList() {
            var res = this.insurTypeOrignalList;
            var checkList = this.checkList;
            if (checkList.length > 0 && res.length > 0) {
                for (let i in res) {
                    res[i].checked = checkList[i];
                }
            }
            return res;
        },
        ...mapState({
            insurTypeOrignalList: state => {
